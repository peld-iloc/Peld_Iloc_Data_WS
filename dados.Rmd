...
Em resumo:
+ Nomes curtos e informativos - informando variável e unidaed
...
Exemplo arquivo [**README**](https://github.com/peld-iloc/data_example/blob/main/peld_iloc_peixes_recifais_EXEMPLO_Thiago_Silveira_2020_08_11.zip)    
...
Existem ferramentas que nos auxiliam no controle de versão e compartilhamento de arquivos como o [git](https://git-scm.com/) e [github](https://github.com/). Estas ferramentas serão abordadas na sessão [Github PELD -ILOC](github.html) juntamente com a apresentação do perfil do github do PELD ILOC.  
