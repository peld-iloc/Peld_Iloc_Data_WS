...
Com o objetivo de documentar procedimentos e armazenar recursos para processamento, divulgação e análise dos dados obtidos pelo **PELD-ILOC** foi idealizada a criação de um perfil no [Github](https://github.com/).

## 2. Objetivos

+ Armazenar recursos para curadoria e acesso aos bancos de dados
+ Atuar como um respositório de dados públicos e privados do projeto (sites, manuais, algoritmos, etc...)
+ Ser um repositório para o compartilhamento de dados e código entre os participantes da rede 
+ Opção de repositório de dados de publicações 


### 2.1 Sugestão de uso

A conta criada no Github apresenta dois perfis: um pessoal e um institucional, os dois acessados com uma mesma senha e login.

<img src= "figs/git_27.png" style= "width:60%">
<br><br>
  

+ **peld-iloc (perfil pessoal)**
+ **Peld-Oceanic-Islands (perfil institucional)**

Sugere-se que o perfil **pessoal** seja usado para a criação de repositórios privados, ou seja de uso interno do **PELD-ILOC**. Para o **perfil institucional** sugere-se que sejam depositados repositórios públicos. Os repositórios públicos podem ser usados para publicação de dados, scripts e sites.
